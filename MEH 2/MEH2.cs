    ...
    static class MEH2
    {
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                {
                    var result = MessageBox.Show("A new version of MEH is available. Would you like to download the update?", "Update Available", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
